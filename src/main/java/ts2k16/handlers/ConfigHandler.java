...
public class ConfigHandler
{
	...
	public static void initConfigs()
	{
		...
		TSSettings.radius = config.getInt("Radius", Configuration.CATEGORY_GENERAL, 3, 1, 32, "Growth effect radius around the player");
		...
		TSSettings.allowHoldShift = config.getBoolean("Allow Crouching", Configuration.CATEGORY_GENERAL, false, "Growth without spamming shift, just sneak");
